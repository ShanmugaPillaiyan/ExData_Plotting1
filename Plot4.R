...
plot(data_analysis$Time, data_analysis$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(data_analysis$Time, data_analysis$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
